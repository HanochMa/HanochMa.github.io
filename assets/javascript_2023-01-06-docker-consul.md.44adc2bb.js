...
<span class="line"><span style="color:#A6ACCD;">     -client:consul服务侦听地址,这个地址提供HTTP、DNS、RPC等服务,默认是127.0.0.1所以不对外提供服务,如果你要对外提供服务改成0.0.0.0</span></span></code></pre></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">version: &#39;3&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">    command: agent -server -bootstrap-expect=3 -node=consul_server_1 -bind=0.0.0.0  -client=0.0.0.0 -datacenter=HanochMa -ui -data-dir /consul/data -config-dir /consul/config</span></span>
...
<span class="line"><span style="color:#A6ACCD;">      - /usr/local/HanochMa/consul/data/server1:/consul/data</span></span>
<span class="line"><span style="color:#A6ACCD;">      - /usr/local/HanochMa/consul/conf/server1:/consul/config</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    command: agent -server -bootstrap-expect=3 -retry-join=consul_server_1 -node=consul_server_2 -bind=0.0.0.0  -client=0.0.0.0 -datacenter=HanochMa -ui -data-dir /consul/data -config-dir /consul/config</span></span>
<span class="line"><span style="color:#A6ACCD;">    environment:</span></span>
<span class="line"><span style="color:#A6ACCD;">      CONSUL_BIND_INTERFACE: &#39;eth0&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">    volumes:</span></span>
<span class="line"><span style="color:#A6ACCD;">      - /usr/local/HanochMa/consul/data/server2:/consul/data</span></span>
<span class="line"><span style="color:#A6ACCD;">      - /usr/local/HanochMa/consul/conf/server2:/consul/config  </span></span>
<span class="line"><span style="color:#A6ACCD;">    ports:</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    command: agent -server -bootstrap-expect=3 -retry-join=consul_server_1 -node=consul_server_3  -bind=0.0.0.0 -client=0.0.0.0 -datacenter=HanochMa -ui -data-dir /consul/data -config-dir /consul/config</span></span>
<span class="line"><span style="color:#A6ACCD;">    environment:</span></span>
<span class="line"><span style="color:#A6ACCD;">      CONSUL_BIND_INTERFACE: &#39;eth0&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">    volumes:</span></span>
<span class="line"><span style="color:#A6ACCD;">      - /usr/local/HanochMa/consul/data/server3:/consul/data</span></span>
<span class="line"><span style="color:#A6ACCD;">      - /usr/local/HanochMa/consul/conf/server3:/consul/config </span></span>
<span class="line"><span style="color:#A6ACCD;">    ports:</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    command: agent -retry-join=consul_server_1 -node=consul_client_1 -bind=0.0.0.0  -client=0.0.0.0 -datacenter=HanochMa -data-dir /consul/data -config-dir /consul/config</span></span>
<span class="line"><span style="color:#A6ACCD;">    environment:</span></span>
<span class="line"><span style="color:#A6ACCD;">      CONSUL_BIND_INTERFACE: &#39;eth0&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">    volumes:</span></span>
<span class="line"><span style="color:#A6ACCD;">    - /usr/local/HanochMa/consul/data/server1:/consul/data</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    volumes:</span></span>
<span class="line"><span style="color:#A6ACCD;">      - ./fabio.properties:/etc/fabio/fabio.properties</span></span></code></pre></div><p>docker exec consul_server_1 consul operator raft list-peers</p><p>docker exec consul_server_11 consul operator raft list-peers</p><p>server 有三个，client有一个</p><h2 id="安装nginx" tabindex="-1">安装nginx <a class="header-anchor" href="#安装nginx" aria-label="Permalink to &quot;安装nginx&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">apt-get install nginx</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">nginx -v</span></span></code></pre></div><p>nginx config</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">server {</span></span>
