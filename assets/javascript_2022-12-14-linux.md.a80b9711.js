...
<span class="line"><span style="color:#A6ACCD;">select CONCAT( &#39;drop table &#39;, table_name, &#39;;&#39; ) FROM information_schema.tables Where table_name LIKE &#39;DAS_%&#39;;</span></span></code></pre></div><h2 id="mysql-备份" tabindex="-1">mysql 备份 <a class="header-anchor" href="#mysql-备份" aria-label="Permalink to &quot;mysql 备份&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">如果是mariadb，可以用官方备份工具， </span></span>
...
<span class="line"><span style="color:#A6ACCD;">速度非常快，可以试一下。 里面的变量自己替换</span></span></code></pre></div><p><a href="https://www.modb.pro/db/454219" target="_blank" rel="noreferrer">https://www.modb.pro/db/454219</a><a href="https://www.cnblogs.com/liuxingke/articles/9216867.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/liuxingke/articles/9216867.html</a></p><p>mysqldump -u USER -p test $(mysql -u USER -p -D test -Bse &quot;show tables like &#39;wiki_%&#39;&quot;)</p><h2 id="cron-周期性计划任务" tabindex="-1">cron 周期性计划任务 <a class="header-anchor" href="#cron-周期性计划任务" aria-label="Permalink to &quot;cron 周期性计划任务&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 最小运行的单位是分钟级别 </span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">mysqldump -h172.16.4.78 -udvs -psunlight2010! --single-transaction metadata &gt; /data/backup/metadata_$(date +%Y%m%d_%H%M%S).sql</span></span></code></pre></div><h2 id="cron-ubuntu-安装" tabindex="-1">cron ubuntu 安装 <a class="header-anchor" href="#cron-ubuntu-安装" aria-label="Permalink to &quot;cron ubuntu 安装&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">安装：apt-get install cron</span></span>
...
<span class="line"><span style="color:#A6ACCD;">chomd a+r afile</span></span></code></pre></div><h2 id="系统服务所在的路径位置" tabindex="-1">系统服务所在的路径位置 <a class="header-anchor" href="#系统服务所在的路径位置" aria-label="Permalink to &quot;系统服务所在的路径位置&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 参考文章</span></span>
...
<span class="line"><span style="color:#A6ACCD;">systemctl set-property dvs-collect CPUShares=500</span></span></code></pre></div><h2 id="查看systemctl-服务日志" tabindex="-1">查看systemctl 服务日志 <a class="header-anchor" href="#查看systemctl-服务日志" aria-label="Permalink to &quot;查看systemctl 服务日志&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 实时查看滚动日志</span></span>
<span class="line"><span style="color:#A6ACCD;">sudo journalctl -u dvs-collect -f</span></span></code></pre></div><h2 id="硬盘-分区-挂载" tabindex="-1">硬盘 分区 挂载 <a class="header-anchor" href="#硬盘-分区-挂载" aria-label="Permalink to &quot;硬盘 分区 挂载&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// lsblk  https://zhuanlan.zhihu.com/p/555993724</span></span>
...
<span class="line"><span style="color:#A6ACCD;">mount /dev/sdb2 /media/test</span></span></code></pre></div><h2 id="linux基础-变量" tabindex="-1">linux基础 变量 <a class="header-anchor" href="#linux基础-变量" aria-label="Permalink to &quot;linux基础  变量&quot;">​</a></h2><ul><li><a href="https://blog.csdn.net/qq_35258036/article/details/123419703" target="_blank" rel="noreferrer">https://blog.csdn.net/qq_35258036/article/details/123419703</a></li></ul>`,35),o=[e];function c(t,r,i,C,A,y){return a(),n("div",null,o)}const u=s(p,[["render",c]]);export{d as __pageData,u as default};
