import{_ as s,o as a,c as n,O as l}from"./chunks/framework.7d656979.js";const D=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2023-01-04-docker.md","lastUpdated":1682239025000}'),p={name:"javascript/2023-01-04-docker.md"},e=l(`<h2 id="linux-下安装docker" tabindex="-1">linux 下安装docker <a class="header-anchor" href="#linux-下安装docker" aria-label="Permalink to &quot;linux 下安装docker&quot;">​</a></h2><ul><li><a href="https://juejin.cn/book/6844733746462064654/section/6844733746545950734" target="_blank" rel="noreferrer">https://juejin.cn/book/6844733746462064654/section/6844733746545950734</a></li></ul><h2 id="配置国内镜像源" tabindex="-1">配置国内镜像源 <a class="header-anchor" href="#配置国内镜像源" aria-label="Permalink to &quot;配置国内镜像源&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// Docker 官方提供的国内镜像源: registry.docker-cn.com</span></span>
...
<span class="line"><span style="color:#A6ACCD;">docker save consul-1&gt;/usr/local/HanochMa/consul-1.tar</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">docker load &lt; /usr/local/HanochMa/consul-1.tar</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">docker export -o /usr/local/HanochMa/consul-2.tar sul</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">// 然后可以拷贝到其他远程服务器上</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">// 将镜像导入（还可以给镜像命名）</span></span>
<span class="line"><span style="color:#A6ACCD;">docker import /usr/local/HanochMa/consul-2.tar consul-2:1.0.1</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">// 通过命令查看生成的镜像</span></span>
