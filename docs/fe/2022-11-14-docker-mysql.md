...
```
 docker cp ba52a9d7d924:/var/lib/mysql/ba52a9d7d924-slow.log  /usr/local/HanochMa
```


## 从宿主机器拷贝到docker容器中
```
 docker cp /usr/local/HanochMa ba52a9d7d924:/var/lib/mysql/ba52a9d7d924-1slow.log  
```