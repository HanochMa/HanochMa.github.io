...
- 117 github.io 搭建自己的个人网站
  - 实际上就是将自己的前端网站打包，然后发布到打包文件 commit 到 HanochMa.github.io
...
- 110 npm publish 发包时异常
  - 403 Forbidden - PUT https://registry.npmjs.org/HanochMa-hello - Forbidden
    ```javascript
    npm修改邮箱，要登录邮箱进行验证
...
- 31 版本号如何设置的问题
  ...
  ![avatar](https://raw.githubusercontent.com/HanochMa/2021/main/image/1/003.png)
...
- 14 markdown 中引入图片的方法：先将图片上传到 github 库，然后找到对应库，图片所在的地方，github 上可预览图片的，此时便可右键查看图片地址[https://raw.githubusercontent.com/HanochMa/2021/main/image/test.png],图片地址类似是这样的，或者点击 download 可以查看到地址的。
  <br/><br/>
  下面代码可以进行设置位置和宽高
  ```javascript
  <div align=center>
    <img src="https://raw.githubusercontent.com/HanochMa/2021/main/image/test.png" width="300" height="450" align="middle" />
  </div>
  ```
  效果如下
  <div align=center>
...
```javascript
![avatar](https://raw.githubusercontent.com/HanochMa/2021/main/image/test.png)
```
...
<div align=center>
  <img src="https://raw.githubusercontent.com/HanochMa/2021/main/image/1/001.png" width="560" height="600" align="middle" />
</div>
